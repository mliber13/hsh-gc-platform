...
function fallbackTitleFromPath(pathname: string): string {
  ...
  if (pathname.startsWith('/pre-read')) return 'Meeting'
  if (pathname.startsWith('/action-items')) return 'My Action Items'
  if (pathname.startsWith('/admin/meeting-prompts')) return 'Meeting Admin'
  if (pathname.startsWith('/meetings')) return 'Meeting History'
