-- Follow-up to 20260806120000: crew profiles often have full_name = their email,
-- so preferring full_name still showed the email. Prefer the linked org_team member
-- name first, and only use full_name when it's a real name (no '@'). Self-contained:
-- redefines both functions so it works regardless of whether 20260806120000 applied.
