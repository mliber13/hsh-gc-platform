-- Customer schedule share: also return the project's Client (for the portal header).
-- Return-type change → drop+recreate. to_jsonb normalizes text-or-object client; the edge
-- function formats it.
